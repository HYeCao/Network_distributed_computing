...
public class FileClient {
	 ...
	 * 
	 * UDP开启的问题，需要服务器端进行创建，（FileServer)
	 * 
	 * @param args
	 ...
	 * @throws IOException
	 */
	private static void UDPget(String fileName, String paths) throws IOException {
		String path = "D:/";// 默认保存目录
		...
		DatagramPacket dp = new DatagramPacket(paths.getBytes(), paths.getBytes().length, socketAddress);
		Usocket.send(dp);
